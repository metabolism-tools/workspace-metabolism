...
`cordis.yml` row exposes all nine wm tools to the DSH agent (audit, health,
explain, verify, `wm_db_check` registered-SQLite checks, `wm_govern` pre-action
policy checks, clean, init, rollback):
