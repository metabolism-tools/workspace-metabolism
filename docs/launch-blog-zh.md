...
提出一种框架，叫 **Agentic Metabolic Engineering（智能体代谢工程）**——用生物学的「代谢」来理解 AI 工作区：它不是一堆文件的静态存放处，而是一个有生命、有容量上限的系统，需要的是**消化**，而不是简单的**删除**。
...
*（草稿结束。发布前请通读一遍；文末可加一句个人介绍，比如「一个在 AI 编程时代折腾工具的普通人」。）*
