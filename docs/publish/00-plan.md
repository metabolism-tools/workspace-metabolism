...
> 进度：✅ v0.2.0 已发布到 PyPI 与 GitHub Release（2026-08-15）；✅ GitHub 讨论区公告已发布（discussions/3）；三份平台文案均为最终版。待办：X → 知乎 → 小红书；公告置顶需网页点击。

## 时间建议

| 步骤 | 平台 | 建议时间（北京时间） | 用时 |
| --- | --- | --- | --- |
| 1 | GitHub（release 说明 + 讨论区公告） | ✅ release 已完成（2026-08-15）；✅ 公告已发布，置顶待网页点击 | 约 15 分钟 |
